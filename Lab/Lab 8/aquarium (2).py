...
Document any assistance you get if you complete the lab after the class period:
    Tutor Abracia-Wendel and Farrukh helped me to figure out how to move the bubble and fish side to side
...
class Fish:
    def __init__(self, x, y, speed, color, count):  
        self.speed = speed
...
class Bubble:
    ...
    def move(self):
        ...
        if self.count in range(0, 10):
            ...
            self.count = 0
        self.circle.move(dx, self.speed)            
...
def setupFish(numFish):
    ...
    for i in range(numFish):
        ...
        fish = Fish(fishX, fishY, fish_speed, randColor(), count)
...
def setupBubbles(numBubbles):
    ...
    for i in range(numBubbles):
        ...
        count = random.randrange(0, 20)
        bubble = Bubble(bubbleX, bubbleY, bubble_speed, count)
